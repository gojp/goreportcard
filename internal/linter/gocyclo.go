...
func (g GoCyclo) Percentage() (float64, []model.FileSummary, error) {
	return GoTool(g.Dir, g.Filenames, []string{"golangci-lint", "run", "--deadline=180s", "--disable-all", "--enable=gocyclo"})
}
